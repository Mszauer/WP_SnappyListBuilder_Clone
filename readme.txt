=== Snappy List Builder ===
Contributors: Martin Szauer, madesnappy
Donate link: http://wordpressplugincourse.com/plugins/snappy-list-builder
Tags: Email, Subscribe, Email List, Email Subscribers, List Builder, Newsletter, MailChimp, CSV, Opt-in, Double Opt-in, Double Optin, Optin, Plugin Course, Ultimate WordPress Plugin Course, Made Snappy, Joel Funk, Martin Szauer
...
A clone of the origin Snappy List builder for learning purposes.
